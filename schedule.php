    ...
    <ul class="schedule-details">
    	...
    	<li>
	    	...
	    	<div class="content">
	    		<time>9.00am</time>
	    		<h2>Tom Hulme</h2>
	    		<p class="position">Position, Company<br />
	    		<a href="#">websitename.com</a></p>
	    		<p>This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris in erat justo. Nullam ac urna eu felis</p>
	    	</div>
    	</li>
    	<li>
