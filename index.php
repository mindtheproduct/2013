...
?>
  ...
  <h1>MindTheProduct 2013 is over!</h1>
  <div class="content-home">
    <h3>Watch the videos and relive the magic.</h3>
  
    <div class="columns">
    <p>We hope you enjoyed this year’s conference.  If you missed it you can watch the videos, read reviews and more on on our blog:</p>

    <ul>
      <li><a href="http://www.mindtheproduct.com/2013/10/mind-the-product-2013-conference-recap/" title="Product Management Conference">The Conference Video</a></li>
      <li><a href="http://www.mindtheproduct.com/2013/10/mind-product-2013-create-amazing-products-exit-billion-dollars-change-future-2/" title="Product Management Conference">Conference Recap</a></li>
      <li><a href="http://www.mindtheproduct.com/tag/mind-the-product-2013/" title="Product Management Conference Video">Watch all the talks</a></li>
    </ul>
    </div>
